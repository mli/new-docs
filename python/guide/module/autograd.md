...
<p align="center"><img src="autograd_gradient.png" alt="drawing" width="400"/></p>
...
<p align="center">
    <img src="autograd_forward_backward.png" alt="drawing" width="400"/>
</p>
...
<p align="center">
    <video width="400" controls playsinline autoplay muted loop>
        <source src="autograd_graph.mp4" type="video/mp4">
    </video>
</p>
...
<p align="center">
    <video width="400" controls playsinline autoplay muted loop>
        <source src="autograd_grad_req.mp4" type="video/mp4">
    </video>
</p>
...
<p align="center">
    <img src="autograd_control_flow.png" alt="drawing" width="400"/>
</p>
...
<p align="center">
    <img src="autograd_control_flow_grad.png" alt="drawing" width="400"/>
</p>
...
<p align="center">
    <video width="400" controls playsinline autoplay muted loop>
        <source src="autograd_head_grad.mp4" type="video/mp4">
    </video>
</p>
