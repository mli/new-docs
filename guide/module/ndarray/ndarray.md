...
<!-- TODO. Adapted from
diveintodeeplearning.org, need to add more details -->
...
In some cases, we need to randomly generate the value of each element in the
...
Fortunately, performing in-place operations in
